...
// ------ AetherMind Studio brand colors

export const aetherPrimary = registerColor('aether.primary',
	{ dark: '#7B2FF7', light: '#7B2FF7', hcDark: '#7B2FF7', hcLight: '#7B2FF7' },
	nls.localize('aetherPrimary', "AetherMind Studio primary brand color."));

export const aetherSecondary = registerColor('aether.secondary',
	{ dark: '#00F0FF', light: '#00F0FF', hcDark: '#00F0FF', hcLight: '#00F0FF' },
	nls.localize('aetherSecondary', "AetherMind Studio secondary brand color."));

export const aetherBackground = registerColor('aether.background',
	{ dark: '#0A0A14', light: '#0A0A14', hcDark: '#0A0A14', hcLight: '#0A0A14' },
	nls.localize('aetherBackground', "AetherMind Studio background color."));
